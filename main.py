...
def run_query():
    ...
    plan_run = portia.run("Topic:" + user_query + "\n" + "Find a video about this topic and use its transcript to compose a short learning note, ensuring the note is written as one paragraph. Prepare a corresponding page name The note should include information describing the key topics covered and should avoid information from the transcript that isn't related to the topic. Write the summary and the URL onto a new page on Notion. Make sure to include the URL.")
